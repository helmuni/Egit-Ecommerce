...
<h1 id="site-name">Ecommerce administration</h1>
        ...
        <div id="user-tools">
            ...
            <strong>hamid</strong>.
                ...
                <a href="indexA.jsp">Deconnexion</a>
...
<div id="content-main">
        ...
        <caption><a href="" class="section">Clients</a></caption>
            ...
            <tbody><tr>
                ...
                <th scope="row"><a href="lcl">Clients</a></th>
            

            
                <td><a href="#" class="addlink">Ajouter</a></td>
        ...
        <div class="module">
        <table summary="Modèles disponibles dans l&#39;application Produits.">
        <caption><a href="#" class="section">Produits</a></caption>
        
            <tbody><tr>
            
                <th scope="row"><a href="lpr2">Produits</a></th>
            

            
                <td><a href="ajouterPrd.jsp" class="addlink">Ajouter</a></td>
        ...
        <h3>Mes actions</h3>
            ...
            <li class="changelink">
               ...
               <br>
                ...
                <span class="mini quiet">Categories</span>
                 <a href="#">INFO</a>
            </li>
            ...
            <li class="changelink">
                ...
                <br>
                    ...
                    <span class="mini quiet">Produits</span>
                 <a href="#">WDF</a>
            </li>
